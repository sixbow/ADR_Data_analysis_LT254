...
\begin{figure}[h!!!!!!!!]
	...
	\caption{\hl{Source: Pieter Nature communications 2014} $f_{ring}= \frac{F_{0}}{\pi Q} \sim 0.1 MHz$}
	\label{fig:}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\linewidth]{../Export_Figures_noGit/TLS_surpression/FiTSubKID1T0.315.png}
	\caption{}
	\label{fig:}
\end{figure}
\FloatBarrier
