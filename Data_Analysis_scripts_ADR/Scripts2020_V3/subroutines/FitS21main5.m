...
%                    in this function. [Freq,|S21|] of the fit made. For
%                    the default parameter FITF0=1 this is a fit resut in
%                    dB space!
...
% plot(resultFres,'k');
% legend('data', 'broad fit (used for input finding)', 'broad data dB','narrow data', 'Realfit, done with narrow range data');
% hold off;
