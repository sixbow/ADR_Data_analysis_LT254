...
lowFupper = 70;    	%upper bound of low F range (level determined by quasiparticles) in Hz
lowFlower = 20;     %upper bound of low F range (level determined by quasiparticles)
